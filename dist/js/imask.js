      ...
      _createClass(PatternInputDefinition, [
        ...
        },
        {
          ...
          value: function extractTail() {
            ...
            return (_this$masked = this.masked).extractTail.apply(
              _this$masked,
              arguments
            );
          }
        },
        {
          ...
          value: function appendTail() {
            ...
            return (_this$masked2 = this.masked).appendTail.apply(
              _this$masked2,
              arguments
            );
          }
        ...
        },
        {
          ...
          value: function doValidate() {
            ...
            return (
              (_this$masked3 = this.masked).doValidate.apply(
                _this$masked3,
                arguments
              ) &&
              (!this.parent ||
          ...
          value: function _appendTailChunks(chunks) {
            ...
            for (var ci = 0; ci < chunks.length && !details.skip; ++ci) {
              ...
              if (chunkBlock) {
                ...
                var remainChars = chunk.value.slice(
        ...
        },
        {
          ...
          value: function extractTail() {
            ...
            return new ChunksTailDetails(
              this._extractTailChunks(fromPos, toPos)
            );
          }
          /**
          @override
            ...
            this._forEachBlocksInRange(fromPos, toPos, function(
              ...
              if (blockChunk instanceof ChunksTailDetails) {
                ...
                if (nearestStop == null) {
                  ...
                  var headFloatChunks = blockChunk.chunks.splice(
                    0,
        ...
        },
        {
          ...
          value: function extractTail() {
            ...
            var tail = _get(
              ...
              "extractTail",
              this
            ).call(this, fromPos, toPos); // $FlowFixMe no ideas
        ...
        */
        },
        {
          ...
          value: function _appendCharRaw(ch) {
            ...
            var previousBeforeTailSeparatorsCount = this._separatorsCount(
            ...
            var beforeTailSeparatorsCount = this._separatorsCount(
              flags.tail && this._beforeTailState
                ? this._beforeTailState._value
                : this._value
            );
